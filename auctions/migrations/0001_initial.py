...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Chategory_name', models.CharField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auctions', models.ManyToManyField(blank=True, related_name='watchlisted', to='auctions.Auction_List')),
        ...
        migrations.AddField(
            ...
            name='Chategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listed_items', to='auctions.chategory'),
        ),
        migrations.AddField(
            model_name='auction_list',
            name='lister',
